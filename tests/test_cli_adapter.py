...
def test_cli_train_predict_integration():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        app.parse_args(["train-cmd", str(train_csv), str(model_pkl)])
        ...
        app.parse_args(["predict-cmd", str(model_pkl), str(historic_csv), str(future_csv), str(predictions_csv)])
